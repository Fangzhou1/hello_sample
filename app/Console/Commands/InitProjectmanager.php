...
class InitProjectmanager extends Command
{
    ...
    {
         $data=[
        //        ['name'=>'童方杰','email'=>'13986151412@139.com','password'=>bcrypt('123456'),'activated'=>true,'created_at'=>Carbon::now(),'updated_at'=>Carbon::now()],
        ...
        //        ['name'=>'沈小燕','email'=>'15872386491@139.com','password'=>bcrypt('123456'),'activated'=>true,'created_at'=>Carbon::now(),'updated_at'=>Carbon::now()],
                ['name'=>'杨文波','email'=>'13507100210@139.com','password'=>bcrypt('123456'),'activated'=>true,'created_at'=>Carbon::now(),'updated_at'=>Carbon::now()],
                 ['name'=>'姚顺予','email'=>'13507100200@139.com','password'=>bcrypt('123456'),'activated'=>true,'created_at'=>Carbon::now(),'updated_at'=>Carbon::now()],
                  ['name'=>'贺德华','email'=>'13971102567@139.com','password'=>bcrypt('123456'),'activated'=>true,'created_at'=>Carbon::now(),'updated_at'=>Carbon::now()],
                   ['name'=>'赵云晖','email'=>'13971611295@139.com','password'=>bcrypt('123456'),'activated'=>true,'created_at'=>Carbon::now(),'updated_at'=>Carbon::now()],
