...
<a class="btn btn-primary" href="javascript:history.back();" role="button">返回</a>
</div>
...
<div class="col-md-12" style="margin-bottom:20px;">
  <div class="panel panel-success">
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          <td scope="row"><input name="project_number" type="text" class="form-control" value='{{$refunddetail->project_number}}'></td>
          ...
          <td scope="row"><input name="unrefund_reason" type="text" class="form-control" value='{{$refunddetail->unrefund_reason}}'></td>
  ...
  <div class="col-md-12" style="margin-bottom:20px;">
    <div class="panel panel-success" style="margin:5px;">
      ...
      <div class="panel panel-success col-md-6">
        <div class="panel-heading"><big>实物退库情况</big></div>
      ...
      <table class="table">
        ...
        <tbody>
          <tr>
            ...
            <td scope="row"><input name="scm_receive_amount" type="text" class="form-control" value='{{$refunddetail->scm_receive_amount}}'></td>
            <td scope="row"><input name="refund_cost" id="refund_cost" type="text" class="form-control" value='{{$refunddetail->refund_cost}}'></td>
    ...
    <div class="panel panel-success col-md-6">
      <div class="panel-heading" ><big>现金退库情况</big></div>
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td scope="row"><input name="unrefund_cost" id="unrefund_cost" type="text" class="form-control" value='{{$refunddetail->unrefund_cost}}'></td>
        </tr>
      </tbody>
    </table>
  </div>
