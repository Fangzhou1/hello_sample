...
<div class="col-md-3">
  ...
  <div class="panel-body">
    ...
    <p>审计中：{{$data['审计中'] or 0}}个<a class="pull-right btn btn-success" href="{{route('settlements.smsmaildetail')}}?name={{$key}}" role="button">短信通知</a></p>
    <p>已退回：{{$data['被退回'] or 0}}个</p>
    <p>已出报告：{{$data['已出报告'] or 0}}个<a class="pull-right btn btn-success" href="{{route('settlements.smsmaildetail')}}?name={{$key}}" role="button">查看详情</a></p>
